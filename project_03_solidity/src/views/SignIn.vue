...
export default defineComponent({
  ...
  async updated() {
    // when the user refreshes the page check again if user is registered
  ...
  mounted() {
    console.log("mounted sing in")
    // on refresh we still get user eth address & balance
    // this.connect()
    // if(this.registered) {
    //   this.$router.push({ name: 'AccountViewer' })
    // }
  ...
  methods: {
    async goToAccount() {
      ...
      if (this.registered) {
        this.$router.push({ name: 'AccountViewer' })
        // console.log('navigating to account viewer')
